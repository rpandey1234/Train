        ...
        if (savedInstanceState == null) {
            ...
            observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    mImageParameters.mPreviewWidth = mTextureView.getWidth();
                    mImageParameters.mPreviewHeight = mTextureView.getHeight();
...
//        int pivotPointX =  mPreviewSize.getWidth() / 2;
//        int pivotPointY = mPreviewSize.getHeight() / 2;
//
